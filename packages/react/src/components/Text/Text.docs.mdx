...
import Text, { Basic, Headings, Body, Elements } from './Text.stories';
...
- Buttons: Apply consistent typography to button text that matches the style defined in the design system.
...
Text can be used to style other elements, such as buttons, labels, and captions.
