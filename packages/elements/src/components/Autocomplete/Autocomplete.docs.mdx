import { Description, DocsStory, ArgsTable } from '@storybook/addon-docs';
...
<DocsStory id="inputs-autocomplete--basic" />
...
<DocsStory id="inputs-autocomplete--multiple" />
...
<DocsStory id="inputs-autocomplete--invalid" />
...
<DocsStory id="inputs-autocomplete--sizes" />

### Rounded

Set `rounded` to `true` to use input box with rounded corners.

<DocsStory id="inputs-autocomplete--rounded" />
